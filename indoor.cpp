...
#define RECT(p, q, z, w) do { \
    ...
    rects.push_back(Vec4i(i,i+1,i+2,i+3)); } while (0)
        ...
        {
            int i = pts.size();
            pts.push_back(Vec3f(x0, y0, z0));
            pts.push_back(Vec3f(x0 + xw, y0, z0));
            pts.push_back(Vec3f(x0 + xw, y0 + yw, z0));
            pts.push_back(Vec3f(x0, y0 + yw, z0));
            rects.push_back(Vec4i(i,i+1,i+2,i+3));
        }
